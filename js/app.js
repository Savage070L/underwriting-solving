...
const App = {
  ...
  _updateYoungCompanyAlert() {
    // Алерт показывается на обеих вкладках с профилем (broadcast по классу
    // .js-young-alert): в «Андеррайтинговом решении» — над блоками, в «Проверке
    // контрагента» — сразу под полем ввода БИН/ИИН, чтобы предупреждение было
    // видно до чтения досье.
