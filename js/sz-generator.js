...
const SZGenerator = {
  ...
  async generate(data, mode) {
    ...
    const subject = isPravlenie
      ...
      : (isAff
          ? 'О вынесении на рассмотрение Совета директоров решения о заключении сделки с аффилированным лицом (договора ОСРНС)'
          : 'О вынесении на рассмотрение Совета директоров решения о заключении крупной сделки (договора ОСРНС)');
