...
const Utils = {
  ...
  // Для аффилированных лиц пакет документов — всегда СД (Совет директоров),
  // независимо от страх. суммы. Страх. сумма / премия — как ввёл пользователь
  // (или из заявки), никакой фиксированной ставки.
  ...
  UPRAV_DIR_ROLE: 'Заместитель Председателя Правления, член Правления',
  UPRAV_DIR_NAME: 'Аринов Д.С.',

  // Underwriting Council members (6 people) — insurance sum <= 3 billion.
  // Аринов Д.С. — теперь Заместитель Председателя Правления, член Правления:
  // поднят на 2-ю позицию (после Кныковой); Уткин/Осинцев сдвинуты ниже.
  AS_MEMBERS: [
  ...
  // Сокращённая форма (КСЖ) — для шапки СЗ («Председателю Правления АО «КСЖ «Standard Life»»).
  COMPANY_SHORT_NAME: 'АО «КСЖ «Standard Life»',
